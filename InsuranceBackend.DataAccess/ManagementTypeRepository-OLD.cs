...
namespace InsuranceBackend.DataAccess
{
    public class ManagementTypeRepository : Repository<ManagementType>, IManagementTypeRepository
    {
        ...
        public IEnumerable<ManagementTypeList> ManagementTypePagedList(int page, int rows)
        {
            ...
            {
                return connection.Query<ManagementTypeList>("dbo.ManagementTypePagedList", parameters,
